...
data.filter((i) => i.type === "personal").map(( i) => (personalIncome  = personalIncome + parseInt(i.income)))
data.filter((i) => i.type === "personal").map(( i) => (personalexpense  = personalexpense + parseInt(i.expense)))
  const chartdata = {
